exports.verses = {
  ...
  userLoginApi: {
    userNotFound: "এই ইমেল আর পাসওয়ার্ড দিয়ে কোনো একাউন্ট খুঁজে পাওয়া যায় নি।",
  ...
  receipt: {
    limitReached: "আপনি প্রতিটি বিক্রির সর্বোচ ৫টি ডিজিটাল রিসিট তৈরি করতে পারবেন। এই বিক্রয়টি ডিজিটাল রিসিটের সীমা পৌঁছে গেছে। সাহায্যের জন্য ফোন দিন 01770947908."
  }
}