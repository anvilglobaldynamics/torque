...
exports.GetOrganizationListApi = class extends Api {
  ...
  __getAggregatedOrganization({ employment, organization, settings }) {
    ...
    let { receiptText1, receiptText2, monetaryUnit, decimanFormatPreset, logoImageId } = settings;
    return {
      ...
      settings: { receiptText1, receiptText2, monetaryUnit, decimanFormatPreset, logoImageId }
    };
  }
