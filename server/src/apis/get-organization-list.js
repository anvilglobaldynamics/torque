...
exports.GetOrganizationListApi = class extends Api {
  ...
  __getAggregatedOrganization({ employment, organization, settings }) {
    ...
    let { receiptText1, receiptText2, monetaryUnit, vatRule, decimalFormatPreset, logoImageId } = settings;
    return {
      ...
      settings: { receiptText1, receiptText2, monetaryUnit, vatRule, decimalFormatPreset, logoImageId }
    };
  }
