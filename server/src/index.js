...
const { AdminGetActiveOrganizationApi } = require('./apis/admin-get-active-organization-list');
...
class Program {
  ...
  async __initializeApis() {
    ...
    server.registerPostApi('/api/admin-get-active-organization-list', AdminGetActiveOrganizationApi);
