...
const { LiteCheckVerificationToken } = require('./apis/lite-check-verification-token');
...
class Program {
  ...
  async __initializeApis() {
    ...
    server.registerPostApi('/api/lite-check-verification-token', LiteCheckVerificationToken);
  }
