...
class Database {
  ...
  */
  ...
  __autoGenerateNextInQueue(collectionName) {
  ...
  autoGenerateKey(collectionName, cbfn) {
    if (!(collectionName in this.__autoGenerationMap)) {
      this.__autoGenerationMap[collectionName] = {
        isBusy: false,
        queue: []
      }
    }
    this.__autoGenerationMap[collectionName].queue.push(cbfn);
    this.__autoGenerateNextInQueue(collectionName);
  }
