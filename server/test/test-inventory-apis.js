...
describe('Inventory', _ => {
  ...
  it('api/get-aggregated-inventory-details (Valid inventoryIdList check)', testDoneFn => {
  ...
  it('api/get-aggregated-inventory-details (Valid inventoryIdList check more)', testDoneFn => {
  ...
  it('api/get-aggregated-inventory-details (Invalid invalidInventoryId in inventoryIdList)', testDoneFn => {
